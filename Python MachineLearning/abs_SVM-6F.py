...
x = np.array([[float(df.loc[i, 'freqBandPowerThetaFz']),
               float(df.loc[i, 'freqBandPowerAlphaPz']),
               float(df.loc[i, 'freqBandPowerAlphaP1']),
               float(df.loc[i, 'freqBandPowerAlphaP2']),
               float(df.loc[i, 'freqBandPowerAlphaP3']),
               float(df.loc[i, 'freqBandPowerAlphaP4'])
               ] for i in df.index])
